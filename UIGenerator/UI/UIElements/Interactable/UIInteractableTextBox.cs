...
{
    class UIInteractableTextBox : UIInteractableTextPanel<string>
    {
        public UIInteractableTextBox(string text, float textScale = 1f, bool large = false) : base(text, textScale, large)
        {
        }
